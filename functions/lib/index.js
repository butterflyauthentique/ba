...
exports.shippingWebhook = exports.syncOrdersWithRazorpay = exports.razorpayWebhook = exports.verifyRazorpayPayment = exports.createRazorpayOrder = exports.nextjsServer = exports.removeAdmin = exports.addAdmin = exports.getAdmins = exports.checkAdmin = exports.getAdminStats = exports.getOrders = exports.deleteProduct = exports.saveProduct = exports.getProduct = exports.getProducts = void 0;
...
const upsertCustomerProfile = async (customer, orderTotal) => {
    if (!customer)
        return null;
...
exports.saveProduct = functions.https.onRequest((req, res) => {
    return corsHandler(req, res, async () => {
        try {
...
exports.removeAdmin = functions.https.onRequest((req, res) => {
    return corsHandler(req, res, async () => {
        try {
...
exports.verifyRazorpayPayment = functions.https.onRequest((req, res) => {
    return corsHandler(req, res, async () => {
        try {
            const { razorpay_order_id, razorpay_payment_id, razorpay_signature, orderData // This will contain cart items, customer info, etc.
             } = req.body;
            if (process.env.NODE_ENV !== 'production') {
            ...
            if (isAuthentic) {
                try {
                    ...
                    try {
                        ...
                        const srResponse = await (0, shiprocket_1.createShiprocketOrder)(fullOrderData);
...
const handleRefundUpdate = async (refund) => {
    try {
...
exports.syncOrdersWithRazorpay = functions.https.onRequest((req, res) => {
    return corsHandler(req, res, async () => {
        try {
...
const syncSingleOrder = async (razorpay, orderId) => {
    try {
...
const syncOrdersInDateRange = async (razorpay, startDate, endDate) => {
    try {
        let syncCount = 0;
        let errorCount = 0;
...
const importOrdersInDateRange = async (razorpay, startDate, endDate) => {
    try {
        let syncCount = 0;
        let createdCount = 0;
        let errorCount = 0;
...
var shippingWebhook_1 = require("./shippingWebhook");
Object.defineProperty(exports, "shippingWebhook", { enumerable: true, get: function () { return shippingWebhook_1.shippingWebhook; } });
